	...
	<div class="row-fluid">
		...
		<div class="widget-content" >
			...
			<div class="form-row">
				...
				<input type="text" class="form-control" name="fechaCreacion" value="<?= $data["fechaCreacion"]; ?>" id="fechaCreacion" readonly>
				<div class="valid-feedback">
				  Esto est&aacute; bien
				</div>
				<div class="invalid-feedback">
			...
			<div class="form-group">
			    ...
			    <textarea type="text" class="form-control" value="<?= $data["comentario"]; ?>" name="comentario" placeholder="<?= $data["comentario"]; ?>" id="comentario" readonly></textarea>
			</div>
			<!--
			<div class="form-group">
