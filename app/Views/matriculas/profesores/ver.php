...
curl_setopt_array($curl, array(
    CURLOPT_URL => base_url()."/index.php/curSecPorProfesor/show/".$id,
		...
		<div class="widget-box">
			...
			<form  method="post" class="needs-validation" novalidate>
				...
				<select id="id_profesor" name="id_profesor" class="form-control" disabled>
				    <option value="<?= $data[0]["idProfesor"]?>"> <?= $data[0]["nombres"]." ".$data[0]["apellidos"]; ?></option>
				</select>
			    </div>

			    <label for="tabla"> Lista de cursos del profesor - Peri&oacute;do <label class="font-weight-bold"> <?= $data[0]["ciclo"];?> </label> </label>
				...
				<?php endforeach; ?>
                            ...
                            <a href="<?= base_url().'/index.php/curSecPorProfesor/listar'; ?>" class="btn btn-primary"> Volver </a>
			</form>
