...
if ($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => base_url()."/index.php/sedes/create",
...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
	...
	<div class="container-fluid">
		...
		<div class="widget-box">
			...
			<form  method="post" action="<?php base_url().'/index.php/sedes/create'?>" enctype="multipart/form-data" class="needs-validation" novalidate>
			    ...
			    <a href="<?php echo base_url().'/index.php/sedes/listar'?>" class="btn btn-danger">Cancelar</a>
			</form>
