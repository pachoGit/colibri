...
curl_setopt_array($curl, array(
  CURLOPT_URL => base_url()."/index.php/sedes",
...
<div id="content">
	...
	<div class="row-fluid">
		...
		<div class="widget-content" >
			...
			<?php
			if ($data["Estado"] == 200) {
			    foreach($data["Detalles"] as $sede) { ?>
			    <tbody>
				<tr class="odd gradeX">
				    <td><?php echo $sede['idSede']; ?></td>
				    <td><?php echo $sede['sede']; ?></td>
				    <td><?php echo $sede['direccion']; ?></td>
				    <td><a href="editar/<?= $sede['idSede']?>" class="btn
						 btn-warning">Editar</a></td>
				    <td><a onclick="return alerta();" href="eliminar/<?= $sede['idSede']?>"
